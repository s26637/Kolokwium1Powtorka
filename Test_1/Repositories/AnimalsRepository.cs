...
public class AnimalsRepository : IAnimalsRepository
{
  ...
  public async Task<AnimalDto> GetAnimal(int id)
  {
	  ...
	  {
		  var insert = @"INSERT INTO Animal VALUES(@Name, @Type, @AdmissionDate, @OwnerId); SELECT @@IDENTITY AS ID";
	  ...
	  {
		  var insert = $"INSERT INTO Procedure_Animal VALUES(@ProcedureID, @AnimalID, @Date)";
